#!/usr/bin/env python3
"""Stage one or more AIPLC npm packages for release."""
...
def tarball_name_for_package(package: str, version: str) -> str:
    if package in CODEX_PLATFORM_PACKAGES:
        platform = package.removeprefix("aiplc-")
        return f"aiplc-npm-{platform}-{version}.tgz"
