...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/rachidlaad/aiplc".cyan().underlined(),
        ...
        let content = text![
            ...
            "https://github.com/rachidlaad/aiplc/releases/latest"
                .cyan()
                .underlined(),
        ];
...
impl HistoryCell for SessionHeaderHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        // Title line rendered inside the box: ">_ Uxarion AIPLC (vX)"
        let title_spans: Vec<Span<'static>> = vec![
            Span::from(">_ ").dim(),
            Span::from("Uxarion AIPLC").bold(),
            Span::from(" ").dim(),
